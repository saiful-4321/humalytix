...
class CompanySettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'logo_white_height' => 'nullable|string|max:20',
            'logo_white_width' => 'nullable|string|max:20',
            'logo_dark' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'logo_dark_height' => 'nullable|string|max:20',
            'logo_dark_width' => 'nullable|string|max:20',
            'logo_white_small' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'logo_white_small_height' => 'nullable|string|max:20',
            'logo_white_small_width' => 'nullable|string|max:20',
            'logo_dark_small' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'logo_dark_small_height' => 'nullable|string|max:20',
            'logo_dark_small_width' => 'nullable|string|max:20',
