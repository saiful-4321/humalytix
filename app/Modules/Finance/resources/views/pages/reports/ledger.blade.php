...
<!-- Filter Offcanvas -->
<x-offcanvas id="filterOffcanvas" title="<i class='fas fa-filter me-2'></i> Ledger Filters">
    <form id="ledgerFilterForm" action="{{ route('finance.reports.ledger') }}" method="GET">
        <div class="mb-3">
    ...
    <x-slot:footer>
        <div class="d-grid gap-2">
            <button type="submit" form="ledgerFilterForm" class="btn btn-primary"><i class="fas fa-search me-1"></i> Show Ledger</button>
