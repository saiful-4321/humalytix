...
<x-offcanvas id="filterOffcanvas" title="<i class='fas fa-filter me-2'></i> Report Filters">
    <form id="summaryFilterForm" action="{{ route('finance.reports.summary') }}" method="GET">
        <div class="mb-3">
    ...
    <x-slot:footer>
        <div class="d-grid gap-2">
            <button type="submit" form="summaryFilterForm" class="btn btn-primary"><i class="fas fa-search me-1"></i> Apply Filters</button>
