<div class="offcanvas offcanvas-end" tabindex="-1" id="sendNotificationOffcanvas" aria-labelledby="sendNotificationLabel" style="width: 600px;">
    <div class="offcanvas-header bg-primary bg-gradient">
        <h5 class="offcanvas-title text-white" id="sendNotificationLabel">
            <i class="bx bx-send me-2"></i>Send Custom Notification
        </h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
        <form action="{{ route('hrm.notifications.store') }}" method="POST" id="notificationForm">
            @csrf
            ...
            <div class="mb-3 department-select" style="display: none;">
            ...
            <div class="mb-3 user-select" style="display: none;">
            ...
            <div class="notification-preview mb-3">
                <div class="d-flex align-items-start">
                    <div class="flex-shrink-0 me-3">
                        <div class="avatar-sm">
                            <span class="avatar-title rounded-circle font-size-16 notification-icon-0" id="preview-icon">
                                <i class="bx bx-bell"></i>
                            </span>
                        </div>
                    </div>
                    <div class="flex-grow-1">
                        <h6 class="font-size-14 mb-1" id="preview-title">Notification Title</h6>
                        <p class="text-muted mb-2 font-size-13" id="preview-message">Your notification message will appear here...</p>
