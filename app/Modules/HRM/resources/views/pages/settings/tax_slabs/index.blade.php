                    ...
                    <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ $gender }}" role="tabpanel">
                        <div class="table-responsive rounded-10 border">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    {{-- Merge 'all' gender entries into every tab or handle separately? 
                                       For now, let's show specific gender matches + 'all' in 'other' or duplicate. 
                                       Actually, usually tax laws act on specific gender. 'All' might be default. 
                                       Let's just filter strictly for now to keep it simple or show 'all' in 'Other/General'.
                                    --}}
                                    @php 
