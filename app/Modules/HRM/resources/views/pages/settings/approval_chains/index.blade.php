...
<div class="block-header">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-4 col-sm-12 text-right">
            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#createChainCanvas" aria-controls="createChainCanvas">
                <i class="bx bx-plus"></i> Create Chain
            </button>
        </div>
    </div>
</div>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('hrm.settings.approval-chains.edit', $chain->id) }}" class="btn btn-sm btn-soft-primary"><i class="bx bx-edit"></i></a>
