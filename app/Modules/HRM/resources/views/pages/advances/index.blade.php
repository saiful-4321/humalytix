                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex gap-2 justify-content-end">
                                        @if($advance->status == 'pending')
                                        <form action="{{ route('hrm.advances.approve', $advance->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-soft-success" title="Approve">
                                                <i class="mdi mdi-check-circle-outline"></i>
                                            </button>
                                        </form>
                                        <form action="{{ route('hrm.advances.reject', $advance->id) }}" method="POST" class="d-inline">
                                            @csrf
                                        ...
                                        @if($advance->status != 'active' && $advance->status != 'completed')
                                        <form action="{{ route('hrm.advances.destroy', $advance->id) }}" method="POST" class="d-inline delete-form">
                                            @csrf
                                            @method('DELETE')
